...
- Ability to write numerous expressions per line. [(See Example)](ontology_test/example/test_while2.py)
- `global` keyword, works the same as [global](https://www.programiz.com/python-programming/global-keyword) in the standard python library. Allows functions to share variables. [(See Example #1)](ontology_test/example/test_global_and_appcall.py) [(See Example #2)](ontology_test/example/test_global.py)
- Cascade bool operation. [(See Example)](ontology_test/example/test_boolop_origin.py)
- Augmented assignment operators such as `+= *= /= -=` [(See Example)](ontology_test/example/test_iterate.py)
- [Chained comparisons](https://www.geeksforgeeks.org/chaining-comparison-operators-python/) [(See Example)](ontology_test/example/test_compare_1.py)
- [Chained assignment](https://stackoverflow.com/questions/7601823/how-do-chained-assignments-work)
- Maps nested within maps. [(See Example)](ontology_test/example/test_dict.py)
- `if expression` statements. [(See Example)](ontology_test/example/test_ifexpr.py)
- `for`, `while`, `break` and `continue`. [(See Example #1)](ontology_test/example/test_for_1.py) [(See Example #2)](ontology_test/example/test_while2.py)
- `if x in y` statements. [(See Example)](ontology_test/example/test_in.py)
- `loop else` statements. [(See Example)](ontology_test/example/test_for_1.py)
- `range(len), range(start, stop), range(start, stop, step)`. [(See Example)](ontology_test/example/test_range.py)
- [Function default argument](https://stackoverflow.com/questions/13195989/default-values-for-function-parameters-in-python) [(See Example)](ontology_test/example/test_default_vararg.py)
- [Function variable argument](https://stackoverflow.com/questions/919680/can-a-variable-number-of-arguments-be-passed-to-a-function) [(See Example)](ontology_test/example/test_default_vararg.py)
- [Pass Starred argument for function call](https://stackoverflow.com/questions/12555627/python-3-starred-expression-to-unpack-a-list) [(See Example)](ontology_test/example/test_default_vararg.py)
- List comprehension. [(See Example)](ontology_test/example/test_list_com.py)
- Dict comprehension. [(See Example)](ontology_test/example/test_dict_com2.py)
- Conditional operation
- Assert. [(See Example)](ontology_test/example/test_split.py)
- [String slicing](https://www.digitalocean.com/community/tutorials/how-to-index-and-slice-strings-in-python-3) [(See Example)](ontology_test/example/test_slice.py)
